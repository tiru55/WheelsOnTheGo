...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 15, 2024 at 04:58 PM
...
(1, '319, 17th Cross, 25th Main Rd, JP Nagar 6th Phase, Bengaluru, Karnataka 560078.', 'wheelsonthego@gmail.com', '7483310098');
...
(11, 'FAQs', 'faqs', '<div><span style=\"font-weight: bold;\">How do I make a reservation?</span></div><div>You can easily make a reservation through our online booking system. Simply select your desired dates, choose a car, and follow the prompts to complete your booking.</div><div><br></div><div><span style=\"font-weight: bold;\">What documents do I need to rent a car?</span></div><div>Typically, you\'ll need a valid driver\'s license, a credit card, and proof of insurance. Additional requirements may vary, so check our terms and conditions for specific details.</div><div><br></div><div><span style=\"font-weight: bold;\">Can I modify or cancel my reservation?</span></div><div>Yes, you can modify or cancel your reservation through our website or by contacting our customer support. Please check our cancellation policy for details.</div><div><br></div><div><span style=\"font-weight: bold;\">What types of cars do you offer for rent?</span></div><div>We offer a variety of cars to suit different preferences and needs, including compact cars, SUVs, sedans, and more. Check our fleet page for details.</div><div><br></div><div><span style=\"font-weight: bold;\">Is there an age restriction for renting a car?</span></div><div>Yes, the minimum age for renting a car is typically 21, and there may be additional fees or restrictions for drivers under 25. Check our rental policies for age-related details.</div><div><br></div><div><span style=\"font-weight: bold;\">How is the rental price calculated?</span></div><div>Rental prices are based on factors such as the type of car, rental duration, and any additional services selected. You can get an instant quote on our website.</div><div><br></div><div><span style=\"font-weight: bold;\">Can I rent a car for a one-way trip?</span></div><div>Yes, one-way rentals are often available, but they may be subject to additional fees. Check with us for specific details and availability.</div><div><br></div><div><span style=\"font-weight: bold;\">Are there any hidden fees I should be aware of?</span></div><div>We strive for transparency, and our pricing is outlined clearly. However, it\'s important to review our terms and conditions to understand any potential fees.</div><div><br></div><div><span style=\"font-weight: bold;\">What happens in case of a breakdown or accident?</span></div><div>In the event of a breakdown or accident, contact our emergency assistance line immediately. We\'ll guide you through the necessary steps for assistance and support.</div><div><br></div><div><span style=\"font-weight: bold;\">Do you offer additional services like GPS or child seats?</span></div><div>Yes, we offer additional services such as GPS navigation, child seats, and more. You can add these during the booking process or inquire at our rental desk.</div>');
...
(9, 'Q6', 3, 'sample', 100, 'Diesel', 2018, 4, 'christian-wiediger-wqyUpI2E454-unsplash.jpg', 'christian-wiediger-wqyUpI2E454-unsplash.jpg', 'christian-wiediger-wqyUpI2E454-unsplash.jpg', 'christian-wiediger-wqyUpI2E454-unsplash.jpg', 'christian-wiediger-wqyUpI2E454-unsplash.jpg', 'Bangalore', 'HSR Layout', 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-01-15 12:09:57', NULL);
